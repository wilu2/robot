...
type StandardCopyLogic struct {
	ctx    context.Context
	ginCtx *gin.Context
	svcCtx *svc.ServiceContext
}

func NewStandardCopyLogic(ginCtx *gin.Context, serviceContext *svc.ServiceContext) StandardCopyLogic {
	return StandardCopyLogic{
...
// StandardCopy 复制准则
func (l *StandardCopyLogic) StandardCopy(req *standard.CopyStandardReq) (err error) {
	var (
