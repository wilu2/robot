...
func newUser(db *gorm.DB) user {
	...
	_user.AuthMethod = field.NewString(tableName, "auth_method")
	_user.ExpiryTime = field.NewInt64(tableName, "expiry_time")
	_user.FailedLogins = field.NewInt32(tableName, "failed_logins")
	_user.LastLoginFailTime = field.NewInt64(tableName, "last_login_fail_time")
...
type user struct {
	...
	ExpiryTime        field.Int64
	FailedLogins      field.Int32
	LastLoginFailTime field.Int64
...
func (u *user) updateTableName(table string) *user {
	...
	u.FailedLogins = field.NewInt32(table, "failed_logins")
	u.LastLoginFailTime = field.NewInt64(table, "last_login_fail_time")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["failed_logins"] = u.FailedLogins
	u.fieldMap["last_login_fail_time"] = u.LastLoginFailTime
